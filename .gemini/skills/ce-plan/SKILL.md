...
- Use the repo-research-analyst skill to: Scope: technology, architecture, patterns. {planning context summary}
- Use the learnings-researcher skill to: planning context summary
...
- Use the best-practices-researcher skill to: planning context summary
- Use the framework-docs-researcher skill to: planning context summary
...
- Use the spec-flow-analyzer skill to: planning context summary, research findings
