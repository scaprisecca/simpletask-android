...
- the ce-review skill - Run comprehensive code reviews
- the ce-work skill - Execute work items systematically
- the ce-compound skill - Document solved problems

**Why `ce:`?** Claude Code has built-in the plan skill and the review skill commands. The `ce:` namespace (short for compound-engineering) makes it immediately clear these commands belong to this plugin.
