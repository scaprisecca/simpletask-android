...
| Trigger | Flow |
|---------|------|
| Code review | the ce-review skill -> Findings -> the todo-triage skill -> Todos |
| Autonomous review | the ce-review skill mode:autofix` -> Residual todos -> the todo-resolve skill |
