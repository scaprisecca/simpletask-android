...
object Constants {
    ...
    const val BROADCAST_PINNED_TASKS_CHANGED = "PINNED_TASKS_CHANGED"
    ...
    const val EXTRA_PINNED_TASK_TEXT = "pinned_task_text"
    const val EXTRA_OPEN_PINNED_TASK = "open_pinned_task"
