...
- Use the @repo-research-analyst skill: Scope: technology, architecture, patterns. {planning context summary}
- Use the @learnings-researcher skill: planning context summary
...
- Use the @best-practices-researcher skill: planning context summary
- Use the @framework-docs-researcher skill: planning context summary
...
- Use the @spec-flow-analyzer skill: planning context summary, research findings
