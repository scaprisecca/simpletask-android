...
1. **Discover Available Skills**:
   ...
   - For maximum compatibility, check project/workspace skill directories in `.github/skills/**/skill.md`, `.codex/skills/**/skill.md`, and `.agents/skills/**/skill.md`
   - Also check user/home skill directories in `~/.copilot/skills/**/skill.md`, `~/.codex/skills/**/skill.md`, and `~/.agents/skills/**/skill.md`
